...
public class MyBot {
    ...
    public static void main(final String[] args) {
        ...
        final GameMap gameMap = networking.initialize("Neumann-v30");
                ...
                for (final Planet planet : gameMap.getSortedPlanets(ship)) {
                    if (ship.canDock(planet) && planet.isFull() == false) {
                        ...
                        if (planet.getOwner() == gameMap.getMyPlayerId()) {
                            ...
                            if((planet.isOwned() && ship.getId() % 3 != 0)){
                                continue;
                            }
                        }
                    }
                   ...
                   if(ship.getDistanceTo(gameMap.getSortedEnemyShips(ship).get(0)) < 75){
                       shipIsHarvester = false;
