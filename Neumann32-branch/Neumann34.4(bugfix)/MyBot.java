    ...
    public static void main(final String[] args) {
        ...
        for (;;) {
            ...
            for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                ...
                if(ship.getDistanceTo(gameMap.getSortedEnemyShips(ship).get(0)) < 42 && (ship.getDockingStatus() == Ship.DockingStatus.Undocked)){
                ...
                if(!gameMap.getSortedDangerousEnemyShips(ship).isEmpty() && (ship.getDockingStatus() == Ship.DockingStatus.Docked)){
                    if(ship.getDistanceTo(gameMap.getSortedDangerousEnemyShips(ship).get(0)) < 42){
