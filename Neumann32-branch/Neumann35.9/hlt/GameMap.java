...
public class GameMap {
    ...
    public Position getClosestHideout(Ship ship){
        ArrayList<Position> Hideouts = new ArrayList<>();
        Hideouts.add(new Position(5,5));
        Hideouts.add(new Position(getWidth() - 5 ,getHeight() - 5));
        Hideouts.add(new Position(getWidth() - 5, 5));
        Hideouts.add(new Position(5,getHeight() - 5));
        Position closestHideout = new Position(0,0);
        
        for(int i = 0; i < Hideouts.size(); i++){
            if(ship.getDistanceTo(Hideouts.get(i)) < ship.getDistanceTo(closestHideout)){
                closestHideout = Hideouts.get(i);
            }
        }
