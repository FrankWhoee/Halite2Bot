        ...
        for (;;) {
            ...
            for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                ...
                for (final Planet planet : gameMap.getSortedPlanets(ship)) {
                    ...
                    if (ship.canDock(planet) && (planet.isFull() == false)) {
                        ...
                        if (planet.getOwner() == gameMap.getMyPlayerId()) {
                            ...
                            if(planet.isOwned() && gameMap.allPlanetsTaken() == false){
                               continue;
                            }
                        }
                    }
                    ...
                    if(gameMap.allPlanetsTaken()){
                        if(ship.getDistanceTo(planet) < (planet.getRadius() + 5) && ship.getOwner() != planet.getOwner() && (ship.getDockingStatus() != ship.getDockingStatus().Undocked)){
                            shipIsHarvester = false;
                        }
                    }
                   ...
                   if(ship.getDistanceTo(largestPlanet) < 90 && !largestPlanet.isOwned()){
