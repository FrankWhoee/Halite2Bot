            ...
            for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                ...
                for (final Planet planet : gameMap.getSortedPlanets(ship)) {
                    ...
                    if(ship.canDock(planet) && !planet.isFull()){
                        ...
                        break;
                    }else if(ship.getDistanceTo(gameMap.nearestVulnerableEnemyShips(ship).get(0)) < 25 || gameMap.allPlanetsTaken() || ship.getDistanceTo(gameMap.getSortedEnemyShips(ship).get(0)) < 15){
