...
public class MyBot {
    ...
    public static void main(final String[] args) {
        ...
        final GameMap gameMap = networking.initialize("SharpVintageCheeseBot-v10");
        ...
        for (;;) {
            ...
            if(cheese == false){
                ...
                for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                    ...
                    //Coward function
                    if(turnNum > 20 && (gameMap.getAllShips().size()/gameMap.getAllPlayers().size()) - 5 > gameMap.getMyPlayer().getShips().size() && (numOfPlayer == 4)){
                    ...
                    for (final Planet planet : gameMap.getSortedPlanets(ship)) {
                        ...
                        if(gameMap.allPlanetsTaken() || ship.getDistanceTo(sortedEnemyShips.get(0)) < 25){
                            ...
                            break;
                        }else if((!planet.isFull() && planet.getId() == gameMap.getMyPlayerId()) || planet.isOwned() == false){
