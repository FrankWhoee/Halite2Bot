...
public class Position {
    ...
    public static Position calculateShipVelocity(double angleRad, int thrust){
        final double velX = Math.cos(angleRad) * (double)thrust;
        final double velY = Math.sin(angleRad) * (double)thrust;
        final Position velocity = new Position(velX, velY);
        return velocity;
    }
