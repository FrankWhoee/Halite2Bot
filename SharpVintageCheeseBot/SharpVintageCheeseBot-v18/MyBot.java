...
public class MyBot {
    ...
    public static void main(final String[] args) {
        ...
        final GameMap gameMap = networking.initialize("SharpVintageCheeseBot-v18");
        ...
        for (;;) {
            Log.log("This is bot SharpVintagecheeseBot-v17, bot is restarting loop");
            Record.clear();
            moveList.clear();
            ...
            if(cheese == false){
                for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                    ...
                    for (final Planet planet : gameMap.getSortedPlanets(ship)){
                        ...
                        if(gameMap.allPlanetsTaken() || ship.getDistanceTo(sortedEnemyShips.get(0)) < 40){
