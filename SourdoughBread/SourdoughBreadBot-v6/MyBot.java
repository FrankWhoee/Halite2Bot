...
public class MyBot {
    ...
    public static void main(final String[] args) {
        ...
        final GameMap gameMap = networking.initialize("SourdoughBreadBot-v6");
            ...
            if(cheese){
                ...
                for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                    ...
                    if(ship.getDistanceTo(enemyShips.get(0)) < 35 || gameMap.isAllPlanetsTaken()){
                        //If you are docked...
                        if(ship.getDockingStatus() == Ship.DockingStatus.Docked && ship.getDistanceTo(enemyShips.get(0)) < 35){
