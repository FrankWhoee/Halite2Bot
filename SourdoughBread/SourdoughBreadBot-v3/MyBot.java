...
public class MyBot {
    ...
    public static void main(final String[] args) {
        ...
        final GameMap gameMap = networking.initialize("SourdoughBreadBot-v3");
            ...
            if(cheese){
                ...
                for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                    ...
                    if(endTime - startTime > 1925){
                        Log.log("Time out detected, skipping rest of bots. Ships ran: " + (botNum - 1) +"/" +gameMap.getMyPlayer().getShips().size());
                        break;
                    }
                    botNum++;
