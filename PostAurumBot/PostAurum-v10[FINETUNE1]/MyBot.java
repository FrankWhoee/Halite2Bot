...
public class MyBot {
    ...
    public static void main(final String[] args) {
        ...
        final GameMap gameMap = networking.initialize("PostAurum-v10");
        ...
        for (;;) {
            ...
            if(turnNum == 1 ){
                ...
                for(Ship ship: gameMap.getMyPlayer().getShips().values()){
                    ...
                    if(ship.getDistanceTo(gameMap.getSortedEnemyShips(ship).get(0)) < 122){
            ...
            if(cheese){
                ...
                for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                    ...
                    */
                    ...
                    //Attack
                    if(ship.getDistanceTo(enemyShips.get(0)) < 28 || gameMap.isAllPlanetsTaken()){
                    ...
                    ArrayList<Planet> nearestPlanets = gameMap.getSortedPlanets(ship);
                    if(ship.canDock(nearestPlanets.get(0)) && !nearestPlanets.get(0).isFull()){
                        moveList.add(new DockMove(ship,nearestPlanets.get(0)));
                        continue;
                    }
                    
                    //Move to dock
                    for (final Planet planet : nearestPlanets) {
