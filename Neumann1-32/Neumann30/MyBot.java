...
public class MyBot {
    ...
    public static void main(final String[] args) {
        ...
        int fractionOfAttackingShips = 15;
        ...
        for (;;) {
            ...
            for (final Ship ship : gameMap.getMyPlayer().getShips().values()) {
                fractionOfAttackingShips = (gameMap.getSortedEnemyShips(ship).size())/20;
                if(fractionOfAttackingShips == 0){
                    fractionOfAttackingShips = 1;
                }
                ...
                for (final Planet planet : gameMap.getSortedPlanets(ship)) {
                    if (ship.canDock(planet) && (planet.isFull() == false) && ((ship.getId() % fractionOfAttackingShips) != 0)) {
                    ...
                    if((ship.getId() % fractionOfAttackingShips) == 0){
