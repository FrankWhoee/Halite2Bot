...
public class Navigation {
            ...
            final double angularStepRad)
    {
        ...
        if(checkForCollisions(ship, angleRad, thrust)) {
        	Log.log("NAVIGATION.navigateShipTowardsTarget: COLLISION VERIFY FAILED. BREAKING OUT OF METHOD");
        	return null;
        }else if(!gameMap.objectsBetween(ship, getNewTarget(ship,angleRad, thrust)).isEmpty()){
        	Log.log("NAVIGATION.navigateShipTowardsTarget: SEGMENTCIRCLEINTERSECT VERIFY FAILED. BREAKING OUT OF METHOD");
        	return null;
